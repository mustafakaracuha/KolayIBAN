...
function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-transparent">
      <div className="w-full md:max-w-4xl mx-0 sm:mx-0 md:mx-auto bg-gradient-to-r from-white via-gray-50 to-white dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 rounded-none md:rounded-br-2xl md:rounded-bl-2xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden px-4 py-6">
        ...
        {/* Mobil Menü Dropdown */}
        {showMobileMenu && (
          <div className="md:hidden border-t border-gray-200 dark:border-slate-700 mt-4 pt-4">
