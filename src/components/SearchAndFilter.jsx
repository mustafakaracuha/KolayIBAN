...
function SearchAndFilter({ 
  ...
  return (
    <div className="card-modern p-4 sm:p-6 md:p-8 mb-4 sm:mb-6 md:mb-8 mobile-search-filter overflow-hidden w-full mt-6 md:mt-14">
      <div className="flex flex-col gap-3 sm:gap-4 md:gap-6 lg:flex-row">
        <div className="flex-1 relative">
          ...
          <select
            ...
            className="input-modern pl-12 md:pl-14 pr-4 py-3 md:py-4 text-sm sm:text-base md:text-lg appearance-none cursor-pointer rounded-xl"
          >
